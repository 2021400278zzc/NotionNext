...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'ZZC', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的求学者,不断的进行学习，了解前沿知识。', // 作者简介
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个程序员, Hi，我是一个求学者,Hi，我是一个探索知识的人,欢迎来到我的博客🎉',
